...
from django.views import generic #从数据库取数据渲染列表的操作比较简单重复，django封装了这个过程提供统一的模板
...
def  detail(request,question_id):
    ...
    try:
        ...
        #由于前端模板语言本质是后端代码，可以把上句话放html页面中写
        #有助于降低后端复杂度
    except Question.DoesNotExist:
        raise Http404("404 此id问题不存在")
    print(question)
    context = {
        'question': question,
